...
| 7 | 함수 길이 | 함수 LOC > 20 (권장) / > 50 (절대) 측정 | objective | low |
| 8 | 순환 복잡도 | 메서드당 CC > 10 (측정) | objective | medium |
| 9 | 파라미터 개수 | 파라미터 ≥ 5 (측정, ≥5는 객체화) | objective | low |
...
### 프로젝트 표준 규칙 (@standards/coding/coding-guidelines.md — **standards 우선**)
