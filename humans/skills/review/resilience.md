...
> @standards/engineering/reliability.md · @standards/hard-won-conventions.md(§아키텍처·회복탄력성 — 실사고 관례, 일반 표준과 긴장하면 이쪽 우선) · @standards/api/api-design.md(§멱등성) · @standards/CLAUDE.md
...
- `production` / `hyperscale` → 아래 체크리스트 적용 (@standards/engineering/reliability.md 티어 열 기준)
