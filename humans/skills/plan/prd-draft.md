...
> ⚠️ **Standards 준수 필수**
> - @standards/planning/prd-guidelines.md (1-페이지 형식, Out of Scope 필수)
> - @standards/product/metrics.md (Goal/Guardrail)
...
`@standards/planning/prd-guidelines.md` 의 1-페이지 형식을 **정확히** 따릅니다. 특히:
