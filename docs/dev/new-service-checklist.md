...
> Platform 서비스 (Kotlin + Spring WebFlux + 헥사고날 아키텍처) 신규 생성 시 참조
...
│   └── src/main/kotlin/io/abillity/{service}/domain/
│       ├── common/
│       │   ├── util/
...
```kotlin
package io.abillity.{service}.domain.common.util
...
```kotlin
package io.abillity.{service}.domain.common.vo

import io.abillity.{service}.domain.common.util.UUIDv7Generator
import java.util.UUID
