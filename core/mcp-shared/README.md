...
cockpit이 관리하는 MCP 서버: **GitHub · Jira · Confluence · Playwright · Slack · Figma**
...
| Playwright | 토큰 불필요 |
| Slack | 토큰 불필요 — 공식 원격 MCP (`https://mcp.slack.com/mcp`), 첫 호출 시 OAuth 브라우저 인증 |
| Figma | https://www.figma.com/developers/api#access-tokens (Personal Access Token, `figd_...`) |
